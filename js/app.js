 ...
 */
    ...
    (() => {
        ...
        var blocks = document.querySelectorAll(".questions__item");
        document.querySelectorAll(".buli");
        [].forEach.call(blocks, (function(item) {
            item.addEventListener("click", (function() {
                if (item.classList.contains("questions__item")) {
                    item.classList.add("reds");
                    item.classList.remove("questions__item");
                } else {
                    item.classList.add("questions__item");
                    item.classList.remove("reds");
                }
            }));
        }));
        class Popup {
        ...
        function initSliders() {
            if (document.querySelector(".frispesGallery__slider")) new core(".frispesGallery__slider", {
                modules: [ Navigation, Pagination, Autoplay, EffectFade, Lazy, Manipulation ],
                slideClass: "frispesGallery__item",
                wrapperClass: "frispesGallery__wrapper",
                ...
                speed: 1e3,
                navigation: {
                    nextEl: ".gallery__arrow_left",
                    prevEl: ".gallery__arrow_right",
                    clickable: true
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".mainScreen__slider")) new core(".mainScreen__slider", {
                modules: [ Pagination, EffectFade, Lazy, Autoplay, Navigation, Scrollbar ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 0,
            ...
            if (document.querySelector(".ourSpaces__slider")) new core(".ourSpaces__slider", {
                ...
                navigation: {
                    nextEl: ".ourSpaces-info__arrow_left",
                    prevEl: ".ourSpaces-info__arrow_right",
                    clickable: true
                },
                pagination: {
                    el: ".swiper-pagination",
            ...
            if (document.querySelector(".reviews__slider")) new core(".reviews__slider", {
                ...
                speed: 800,
                navigation: {
                    nextEl: ".header-reviews__arrow_left",
                    prevEl: ".header-reviews__arrow_right",
                    clickable: true
                },
                pagination: {
                    el: ".swiper-pagination",
